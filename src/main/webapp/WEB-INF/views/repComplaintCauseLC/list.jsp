...
<title>投诉原因分析（大类）</title>
<%@include file="../common/head.jsp"%>
<%@include file="../common/xCauseColumn.jsp"%>
<script type="text/javascript">
	...
	function getParams() {
		...
		var field42 = $("#field42").combobox("getValue");
		var params = "start="+start+"&end="+end+"&field42="+field42;
		return params;
	}
...
<body>
	<div id="toolbar">
		<div style="margin-bottom: 5px">
			...
			类型选择：<select id="field42" name="field42" style="width:100px;" class="easyui-combobox">
			<option value="" selected=”selected">全部</option>
			<option value="ZL">LTE类</option>
			</select>
	...
	<table id="list" cellspacing="0" cellpadding="0" toolbar="#toolbar">
		<thead>
			<tr>
				...
				<th field="TOUSUYANYIN" width="100" sortable="true">投诉原因</th>
