...
<title>重复投诉分析维度</title>
<%@include file="../common/head.jsp"%>
<%@include file="../common/warningDialog.jsp"%>
<script type="text/javascript">
	...
	function getParams() {
		...
		var field30 = $("#field30").combobox("getValue");
		var params = "start=" + start + "&end=" + end + "&field30=" + field30;
		return params;
	}
	...
	function rowFormatter(value, row, index) {
		debugger;
		var field42 = row['FIELD42'];
		field42 = encodeURI(field42);
		var params = getParams();
		params = params + "&field42=" + field42;
...
<body>
	<div id="toolbar">
		<div style="margin-bottom: 5px">
			开始时间: <input id="start" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" editable="false"> 结束时间: <input id="end" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" editable="false"> 网络制式：<select id="field30" name="field30" style="width: 100px;" class="easyui-combobox">
				<option value="" selected=”selected">全部</option>
				<option value="2G">2G</option>
				<option value="3G">3G</option>
				<option value="4G">4G</option>
			</select> <a href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="doSearch()">查询</a> <a href="#" class="easyui-linkbutton" iconCls="icon-reload" plain="true">刷新</a> <a href="#" class="easyui-linkbutton" iconCls="icon-save" plain="true">导出</a>
		</div>
	</div>
	<table id="list" cellspacing="0" cellpadding="0" toolbar="#toolbar">
		<thead>
			<tr>
				<th field="FIELD42" width="160" sortable="true">投诉区域小区覆盖</th>
				<th field="NEWCOUNT" width="100" sortable="true" formatter="rowFormatter">出现次数</th>
				<th field="OLDCOUNT" width="100" sortable="true">历史出现次数</th>
				<th field="FIELD28" width="100" sortable="true">投诉号码</th>
				<th field="FIELD30" width="100" sortable="true">网络制式</th>
