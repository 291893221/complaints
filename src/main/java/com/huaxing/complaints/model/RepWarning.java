package com.huaxing.complaints.model;

public class RepWarning {
    ...
    public String getBlackdot() {
        return blackdot;
    }

    public void setBlackdot(String blackdot) {
        this.blackdot = blackdot == null ? null : blackdot.trim();
    }
    ...
    public void setChangjing(String changjing) {
        this.changjing = changjing == null ? null : changjing.trim();
    }
    ...
    public String getHuawuliang() {
        return huawuliang;
    }

    public void setHuawuliang(String huawuliang) {
        this.huawuliang = huawuliang == null ? null : huawuliang.trim();
    }
    ...
    public void setLiuliang(String liuliang) {
        this.liuliang = liuliang == null ? null : liuliang.trim();
    }
    ...
    public void setIsnps(String isnps) {
        this.isnps = isnps == null ? null : isnps.trim();
    }
