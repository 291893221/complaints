...
<script type="text/javascript">
	...
	function rowFormatter(value, row, index) {
		...
		params = params + "&field28=" + field28;
		paramsArr.push(params);
		index = paramsArr.length - 1;
		var url = '"../repWarningCell/detailJson"';
...
<body>
	<div id="toolbar">
		<div style="margin-bottom: 5px">
			...
			网络制式：<select id="field30" name="field30" style="width:100px;" class="easyui-combobox">
